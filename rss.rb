...
client = Twitter::REST::Client.new(
	consumer_key:        "w2mTKClMjW2wybFU31uUzJqYL",
	consumer_secret:     "vvOMAfIzxJkKqG0KRwz1v9y8vXqSuTmmU5v44Q1vt7Q3ryWTNi",
	access_token:        "2503477207-p09NIqLVsya4hOoNfPMChlVUkw1X7QOlSDR8YW2",
	access_token_secret: "h3V3h0LiajdVpx6RT7aE019O3Bx583X1XXbZEpveg3XNm",
)
...
record_slinux = db.execute "select * from slinux order by time desc limit 10;"
